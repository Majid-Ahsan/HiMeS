...
> **Version:** v25.3 · **Stand:** 2026-04-20 · **Pfad:** `docs/MASTER-REFERENCE.md`
...
- **Phase 1.5.32** Calendar Assertion-Layer: **nicht mehr optional**. Post-Deploy-Tests haben beide erwartete Drift-Muster reproduziert. Konkrete Scope-Konkretisierung: (a) pro Wochentag+Datum-Paar im Antworttext deterministisch den richtigen Wochentag berechnen (Python `date.fromisoformat().weekday()`), bei Diskrepanz Disclaimer mit **konkreter Korrektur**. (b) pro Event-Nennung prüfen ob Datum im Text mit DTSTART des Events im selben Turn-Tool-Output übereinstimmt. Soft-Guard-Design wie HallucinationGuard. Nächster Task nach dieser Session.
