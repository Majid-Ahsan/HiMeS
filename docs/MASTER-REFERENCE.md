...
> **Version:** v25.16 · **Stand:** 2026-05-03 · **Pfad:** `docs/MASTER-REFERENCE.md`
...
- Schritt 8: ✅ **FERTIG mit Bug-1-Fix (2026-05-03)**. Pipeline End-to-End mit echten Daten verifiziert (2026-04-21-Eintrag erfolgreich gespeichert + ingestet + via cognee_search wieder gefunden ohne Doppel-Restart). Bug 1 (Kuzu-Lock-Konflikt) strukturell behoben durch PR #14 (D3 Subprocess-Refactor, commit 0480fe1). Verbleibende Bugs: Bug 2 (Bot-MCP-Init nach Cognee-Restart, möglicherweise transient — durch D3 weniger relevant), Bug 3 (Notion-Patient-Routing, Datenleck-Risiko, separater PR geplant) und Bug 4 (Cognee-LLM-Halluzination beim Graph-Build, eigene Phase wert). 163 Tests grün (48 memo + 20 server + 73 hints + 15 ingest + 7 system_prompt). Voice (Schritt 8b) folgt nach Text-Verifikation.
