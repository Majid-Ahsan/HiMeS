...
async def list_tools() -> list[Tool]:
    ...
    tools = [
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "location": {
                        "type": "string",
                        "description": "Event location (name or address)",
                        "default": "",
                    },
                    "location_geo": {
                        "type": "string",
                        "description": "Geo coordinates as 'latitude,longitude' (e.g. '50.9375,6.9603') for Apple Maps integration. If provided, the location will be clickable in Apple Calendar.",
                        "default": "",
                    },
                    "start_time": {
                        "type": "string",
        ...
        Tool(
            ...
            description="Update an existing event by UID. Only provided fields are changed — omit fields you don't want to modify.",
            inputSchema={
                "type": "object",
                "properties": {
                    "uid": {
                        "type": "string",
                        "description": "UID of the event to update (get from caldav_search_events or caldav_get_events)",
                    },
                    "calendar_index": {
                        "type": "integer",
                        "description": "Index of the calendar (default: 0)",
                    ...
                    "location": {
                        "type": "string",
                        "description": "New event location (optional, auto-geocoded)",
                    },
                    "start_time": {
                        "type": "string",
                    ...
                    "reminders": {
                        "type": "array",
                        "description": "New reminders (replaces existing). Each: {minutes_before, action}",
                        "items": {
                            "type": "object",
                            "properties": {
                                "minutes_before": {"type": "integer"},
                    ...
                    "attendees": {
                        "type": "array",
                        "description": "New attendees (replaces existing)",
                        "items": {
                            "oneOf": [
                                {"type": "string"},
                                {
...
async def call_tool(name: str, arguments: Any) -> Sequence[TextContent]:
    ...
    try:
        if name == "caldav_list_calendars":
            ...
            location_geo = arguments.get("location_geo", "")
