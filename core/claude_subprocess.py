...
SYSTEM_PROMPT = (
    ...
    "\n\n"
    "## Wochentag-Regel (KRITISCH — domain-übergreifend)\n"
    "Wochentage NIEMALS aus einem Datum raten — IMMER via time-MCP convert_time "
    "verifizieren. Gilt für ALLE Anfragen (Kalender, Bahn, Notion, ...), nicht "
    "nur eine Domain.\n"
    "- Falsch: '24. April ist ein Donnerstag' (geraten, tatsächlich Freitag!)\n"
    "- Richtig: time-MCP → '24.04.2026 ist ein Freitag', dann antworten\n"
    "Auch bei: 'nächsten Freitag' / 'letzten Montag' / wiederkehrenden Serien "
    "('immer donnerstags') → Datum UND Wochentag BEIDE per time-MCP prüfen.\n"
    "Bei verschobenen Kalender-Einzelinstanzen: der NEUE Wochentag zählt, "
    "nicht der Original-Serie-Wochentag.\n"
    "Kein time-MCP-Call in diesem Turn → gib KEINE Wochentag-Angabe.\n"
    "\n\n"
    "## Deine Tools\n"
