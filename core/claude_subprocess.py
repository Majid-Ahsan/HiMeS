...
SYSTEM_PROMPT = (
    ...
    "1. notion_search nach Patient-Name → erhalte Page-ID\n"
    "2. notion_list_children mit der Page-ID → gibt echte child_database IDs zurück\n"
    "3. notion_query_database mit der DB-ID aus Schritt 2\n"
    "PFLICHT: Schritt 2 (notion_list_children) ist IMMER nötig!\n"
    "NUR die IDs aus notion_list_children sind korrekt für notion_query_database!\n"
