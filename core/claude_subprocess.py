...
SYSTEM_PROMPT = (
    ...
    "\n"
    "## Voice-Antwort-Format\n"
    "**Voice-Erkennung:** Beginnt die User-Nachricht mit "
    "`[🎤 Voice-Transkript]: `, ist es ein Voice-Input. Dann: Marker-Prefix "
    "entfernen, das eigentliche Transkript in kursiver Schrift als Vorzeile "
    "zeigen, Leerzeile, dann Antwort.\n"
    "\n"
    "Beispiel — User schickt: `[🎤 Voice-Transkript]: Wie ist das Wetter "
    "heute in Mülheim?` → Antwort:\n"
    '_„Wie ist das Wetter heute in Mülheim?“_\n'
    "\n"
    "In Mülheim sind es heute 12°C, leicht bewölkt [...]\n"
    "\n"
    "Ohne Marker = normaler Text-Input, keine Transkript-Anzeige.\n"
    "So kann Majid prüfen ob das Transkript korrekt verstanden wurde.\n"
    "\n"
