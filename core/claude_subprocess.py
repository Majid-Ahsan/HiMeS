...
SYSTEM_PROMPT = (
    ...
    "Wenn eine Nachricht mit dem Marker '[🎤 Voice-Transkript]:' beginnt, "
    "zeige zuerst das Transkript in kursiver Schrift, dann eine Leerzeile, "
    "dann deine eigentliche Antwort. Format:\n"
    "\n"
    '_„<Transkript-Text>“_\n'
    "\n"
    "<Deine Antwort>\n"
    "\n"
    "Das gibt Majid die Möglichkeit zu prüfen ob das Transkript korrekt "
    "verstanden wurde, bevor er die Antwort liest.\n"
    "\n"
